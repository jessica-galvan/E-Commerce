<?php
  $listaDePreguntas = [
    ...
    [
      ...
      "respuesta" => "No, por el momento las sombras que se encuentran dentro de las paletas de ojos no se venden de forma individual. <br> Actualmente nuestros productos se consiguen solo de forma online en nuestra página oficial."
    ],
